...
import sana_about from "../Assets/videos/sana-about.mp4";
import sana_1 from "../Assets/videos/sana1.mp4";
import sana_2 from "../Assets/videos/sana2.mp4";
import sana_3 from "../Assets/videos/sana3.mp4";
import Brands from "./Brands";
import type1 from "../Assets/img/sanaType1.PNG";
import type2 from "../Assets/img/sanaType2.PNG";
import GoTop from "./GoTop";

const SanaPanel = ({ lang }) => {
  ...
  const menu = ["about", "sanaPanel"];
  return (
    <>
      <Navigation navs={menu} />
      {/* Home */}
      <div id="s-head">
        <div className="s-h-overlay">
          <img src={sana} className="image-fluid" alt="" />
          <h3 className="mt-5 text-white">{t("s_top_header1")}</h3>
        </div>
      </div>
      {/* Brands */}
      <Brands />
      ...
      {/* bg-image */}
      <div id="sanaPanel" className="s-bg-compo" data-aos="fade-in" data-aos-duration="1000"></div>
          ...
          <div className="article">
            ...
            <div className="whatssandwich mb-5" data-aos="fade-in" data-aos-duration="1500">
              <Container>
                ...
                <div className="app-text">
                  <p className="w-75">{t("s_whatspanel_p")}</p>
                </div>
              </Container>
            </div>
            {/* Services */}
                  ...
                  <table className="table table-sm text-center w-75">
                    <thead>
                      <tr className="table-primary">
                        <th scope="col">{t("s_specifics")}</th>
                        <th scope="col">{t("s_roof")}</th>
                        <th scope="col">{t("s_wall")}</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td>{t("s_spec_width")}</td>
                        <td>{t("s_f_1")}</td>
                        <td>{t("s_f_1")}</td>
                      </tr>
                      <tr>
                        <td>{t("s_spec_length")}</td>
                        <td>{t("s_f_2")}</td>
                        <td>{t("s_f_2")}</td>
                      </tr>
                      <tr>
                        <td>{t("s_spec_thikness")}</td>
                        <td>{t("s_f_3")}</td>
                        <td>{t("s_f_3")}</td>
                      </tr>
                      <tr>
                        <td>{t("s_spec_density")}</td>
                        <td>
                          {t("s_f_4")}
                          <sup>3</sup> {t("s_f_4a")}
                        </td>
                      ...
                      <tr>
                        <td>{t("s_spec_thermal")}</td>
                        <td>{t("s_f_5")}</td>
                        <td>{t("s_f_5")}</td>
                      </tr>
                      <tr>
                        <td>{t("s_spec_sound")}</td>
                        <td>{t("s_f_6")}</td>
                        <td>{t("s_f_6")}</td>
                      </tr>
                    </tbody>
            ...
            <div className="application mb-5" data-aos="fade-in" data-aos-duration="1500">
              <Container>
                ...
                <div className="app-text">
                  <p className="w-75">{t("s_application_p")}</p>
                </div>
              </Container>
            </div>
            {/* Product Types */}
                  ...
                  <Row>
                    ...
                    <Col sm={12} md={7} className="px-md-4 px-lg-5">
                      <ul className="p-0 m-0 ">
                        <li>{t("s_specific_1")}</li>
                        <li>{t("s_specific_2")}</li>
                        <li>{t("s_specific_3")}</li>
                        <li>{t("s_specific_4")}</li>
                        <li>{t("s_specific_5")}</li>
                        <li>{t("s_specific_6")}</li>
                        <li>{t("s_specific_7")}</li>
                        <li>{t("s_specific_8")}</li>
                        <li>{t("s_specific_9")}</li>
                        <li>{t("s_specific_10")}</li>
                        <li>{t("s_specific_11")}</li>
                        <li>{t("s_specific_12")}</li>
                        <li>{t("s_specific_13")}</li>
                        <li>{t("s_specific_14")}</li>
                        <li>{t("s_specific_15")}</li>
                        <li>{t("s_specific_16")}</li>
                      </ul>
                    </Col>
                  </Row>
                </Container>
          ...
          <Container>
            <Row>
              ...
              <Col lg={{ span: 6, order: 1 }} className="left-col px-4 py-4">
                <img src={sana} className="image fluid s-about-logo " alt="" />
                <h3
                ...
                <div className="text-center mt-4 mt-lg-5">
                  <p className="fs-7 mb-4 ">{t("s_about_p")}</p>
                  <h6>{t("address")}</h6>
                  <p className="px-5">{t("s_add_value")}</p>
                  <h6>{t("phone")}</h6>
